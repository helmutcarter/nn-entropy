// Backup before I make changes in formatting to make output csv-like
use nn_entropy::*;
use std::env;
...
fn main() {
    ...
    let mut one_d_data: Vec<Vec<f64>> = load_one_d_data("/home/helmut/Downloads/JC_NN_Code_backup/steve_unrestrained_1000000_ICs.csv");
